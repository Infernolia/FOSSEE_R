...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
# 1) Part 1: Loading the necessary data files for the project.
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
# 2) Part 2: Label encoding for conversion of strings to numeric data.
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
# 2.1) Encoding `Target Audience` label to numeric, student to 1, teaching faculty and others to 5.
df$`Target Audience` <- ifelse(df$`Target Audience`=="Student", 1, 5)

# 2.2) Processing the `Pre-Workshop Training` column to convert number of days to level of training from 1 to 5.
...
# 2.3) Processing the `Already Using Modelling Software in Org` column and setting the values Yes, Not Sure and No in the range 5 to 1.
df[df$`Already Using Modelling Software in Org`=="Yes", "Already Using Modelling Software in Org"] <- 5
df[df$`Already Using Modelling Software in Org`=="No", "Already Using Modelling Software in Org"] <- 1
df[df$`Already Using Modelling Software in Org`=="Not Sure", "Already Using Modelling Software in Org"] <- 3

# 2.4) Processing the `Used Jmol Before` column and setting the values No and Yes to 1 and 5.
df[df$`Used Jmol Before`=="Yes", "Used Jmol Before"] <- 5
df[df$`Used Jmol Before`=="No", "Used Jmol Before"] <- 1

# 2.5) Processing the `Difficulty in Teaching/Learning Without 3D Viewer` column and setting the values Very Difficult to Very Easy in the range 5 to 1.
...
# 2.5) Processing the `Jmol Usefulness in Teaching/Learning` column and setting the values Yes, May be and No in the range 5 to 1.
...
# 2.6) Processing the `Jmol Difficulty for Teaching` column and setting the values Very Difficult to Very Easy in the range 1 to 5.
...
# 2.7) Processing the`3D Visualization Will Create Interest` column and setting the values Yes, May be and No in the range 5 to 1.
...
# 2.8) Processing the`Jmol Usefulness in Assessing Students` column  and setting the values Yes, May be and No in the range 5 to 1.
...
# 2.9) Cleaning the assignment based questions and setting the values Not Attempted to 3. The other values are already numeric in nature and need not be converted.
df[df$`(Assmt 1) Intro To Jmol Application`=="Not Attempted", "(Assmt 1) Intro To Jmol Application"] <- "3"
df[df$`(Assmt 2) Create and Edit Molecular Models`=="Not Attempted", "(Assmt 2) Create and Edit Molecular Models"] <- "3"
df[df$`(Assmt 3) Modify Display and View`=="Not Attempted", "(Assmt 3) Modify Display and View"] <- "3"
df[df$`(Assmt 4) Measurements and Labelling`=="Not Attempted", "(Assmt 4) Measurements and Labelling"] <- "3"
df[df$`(Assmt 5) Script Console and Script Commands`=="Not Attempted", "(Assmt 5) Script Console and Script Commands"] <- "3"
df[df$`(Assmt 6) Surfaces and Orbitals`=="Not Attempted", "(Assmt 6) Surfaces and Orbitals"] <- "3"
df[df$`(Assmt 7) Crystal Structure and Unitcell`=="Not Attempted", "(Assmt 7) Crystal Structure and Unitcell"] <- "3"

# 2.10) Cleaning the concept based questions and setting the values in the range Unaware to Expert to the range 1 to 6. 
...
# 2.11) Cleaning the positive workshop feedback based questions and setting the values in the range Extremely Bad to Excellent to the range 1 to 6. 
df[df$`Quality Instructional Material`=="Extremely bad", "Quality Instructional Material"] <- "1"
df[df$`Quality Instructional Material`=="Bad", "Quality Instructional Material"] <- "2"
df[df$`Quality Instructional Material`=="Not sure", "Quality Instructional Material"] <- "3"
df[df$`Quality Instructional Material`=="Acceptable", "Quality Instructional Material"] <- "4"
df[df$`Quality Instructional Material`=="Good", "Quality Instructional Material"] <- "5"
df[df$`Quality Instructional Material`=="Excellent", "Quality Instructional Material"] <- "6"
...
# 2.12) Cleaning the positive workshop feedback based questions and setting the values in the range Strongly Disagree to Strongly Agree to the range 1 to 5. 
...
# 2.13) Cleaning the negative workshop feedback based questions and setting the values in the range Strongly Disagree to Strongly Agree to the range 5 to 1. 
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
# 3) Part 3: Making scale of all questions uniform.
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#

# 3.1) Reversing the scales of spoken tutorial questions to make 1 represent "extremely difficult to understand and follow" and 5 as "extremely easy to understand and follow" so that 1 represents bad feedback and 5 represents good feedback as specified in our data labelling convention.
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
# 4) Part 4: Converting data type of all columns to uniform type.
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#

# 4.1) Casting all the numeric data as numeric data type as this is required for EFA analysis.
df <- data.frame(apply(df, 2, function(x) as.numeric(as.character(x))))

#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
# 5) Part 5: Grouping columns into meaningful groups for group-wise EFA.
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#

# 5.1) Grouping the data into 4 convenient chunks for processing: all columns, spoken tutorial and assignments related, concepts related and overall workshop feedback.
df_all <- df
...
# 5.2) Saving the groups of data in separate csvs for future EFA analysis.
write.csv(df_all,"data_efa_all.csv")
write.csv(df_spoken,"data_efa_spoken.csv")
write.csv(df_concepts,"data_efa_concepts.csv")
write.csv(df_overall,"data_efa_overall.csv")
