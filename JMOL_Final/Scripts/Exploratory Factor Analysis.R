...
# 2.2.1) Plug in the csv which you want to load in Section 2. Use:
#  a.	data_efa_all.csv: For all original features
#  b.	data_efa_spoken.csv: For all spoken tutorial and assignment features.
#  c.	data_efa_concepts.csv: For the before and after workshop concept specific features.
#  d.	data_efa_overall.csv: Overall background and workshop related features.
df <- read.csv("data_efa_concepts.csv")
