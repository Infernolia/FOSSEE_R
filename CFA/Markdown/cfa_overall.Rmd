---
title: "CFA Analysis of  Overall Feedback"
...
wisc.model1 <- '
positive =~   a1 + a2 + a3 + a4 + a5 + a7 + a8 + a10  + a11 + a12
negative =~     a6 +  a9  +  a13 + a14 + a15'
...
# Part 10: Path Diagram for the bifactor Model 1
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
- The features Selective.admission.for.less.crowd.R.,Apply.fee.so.the.crowd.decrease.R. strongly belong to the factor negative feedback.
- The features Quality.of.instruction, Interacting.with.FOSSEE.team, Overall.exposure, Will.recommend.workshop.for.friend, Happy.with.format strongly belong to the factor positive feedback.
