df <- read.csv("C:/Users/Aboli/Desktop/tmp/FOSSEE/Code/jmol/data_cleaned_final.csv")
...
length(colnames(df_all)) + length(colnames(df_spoken)) + length(colnames(df_overall)) + length(colnames(df_concepts))
 

write.csv(df_all,"C:/Users/Aboli/Desktop/tmp/FOSSEE/Code/jmol/data_all.csv")
write.csv(df_spoken,"C:/Users/Aboli/Desktop/tmp/FOSSEE/Code/jmol/data_spoken.csv")
write.csv(df_concepts,"C:/Users/Aboli/Desktop/tmp/FOSSEE/Code/jmol/data_concepts.csv")
write.csv(df_overall,"C:/Users/Aboli/Desktop/tmp/FOSSEE/Code/jmol/data_overall.csv")
