...
# Part 4: Making the scale of all feature uniform
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
# Part 5: Generating descriptive statistics and saving cleaned data.
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
# Part 6: Grouping data for exploratory analysis
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
#Writing groups of cleaned data to different csvs
write.csv(df_background,"cleaned_background.csv")
write.csv(df_spoken,"cleaned_spoken.csv")
write.csv(df_live,"cleaned_live.csv")
write.csv(df_overall,"cleaned_overall.csv")
```
