#-------------------------------------------------------------------------------------------------------------#
#1) Part 1: Loading data
#-------------------------------------------------------------------------------------------------------------#

# Reading Data from csv file. 
setwd("C:/Users/Aboli/Desktop/tmp/FOSSEE/Code/jmol")
df <- read.csv("cleaned_14th_may_2.csv")

#-------------------------------------------------------------------------------------------------------------#
#2) Part 2: Bringing dataframe to standard  form
#-------------------------------------------------------------------------------------------------------------#
...
df[df$Using_Software_Other_In_Org=="No", "Using_Software_Other_In_Org"] <- 1
df[df$Using_Software_Other_In_Org=="Not Sure", "Using_Software_Other_In_Org"] <- 3
...
#Cleaning the assignment based questions 
df[df$A1_Introduction_to_Jmol_Application=="Not Attempted", "A1_Introduction_to_Jmol_Application"] <- "3"
df[df$A2_Create_and_Edit_Molecular_Models=="Not Attempted", "A2_Create_and_Edit_Molecular_Models"] <- "3"
df[df$A3_Modify_Display_and_View=="Not Attempted", "A3_Modify_Display_and_View"] <- "3"
df[df$A4_Measurements_and_Labelling=="Not Attempted", "A4_Measurements_and_Labelling"] <- "3"
df[df$A5_Script_Console_and_Script_Commands=="Not Attempted", "A5_Script_Console_and_Script_Commands"] <- "3"
df[df$A6_Surfaces_and_Orbitals=="Not Attempted", "A6_Surfaces_and_Orbitals"] <- "3"
df[df$A7_Crystal_Structure_and_Unitcell=="Not Attempted", "A7_Crystal_Structure_and_Unitcell"] <- "3"
...
df[df$Jmol_Crystal_Knowledge_Before=="Not Applicable", "Jmol_Crystal_Knowledge_Before"] <- "3"
...
df[df$Jmol_Crystal_Knowledge_After=="Not Applicable", "Jmol_Crystal_Knowledge_After"] <- "3"
...
#-------------------------------------------------------------------------------------------------------------#
#4) Part 4: Making scale of all questions uniform
#-------------------------------------------------------------------------------------------------------------#
...
df[df$ST_Introduction_to_Jmol_Application=="Not Attempted", "ST_Introduction_to_Jmol_Application"] <- "3"
df[df$ST_Introduction_to_Jmol_Application=="Not Applicable", "ST_Introduction_to_Jmol_Application"] <- "3"
...
df[df$ST_Create_and_Edit_Molecular_Models=="Not Attempted", "ST_Create_and_Edit_Molecular_Models"] <- "3"
df[df$ST_Create_and_Edit_Molecular_Models=="Not Applicable", "ST_Create_and_Edit_Molecular_Models"] <- "3"
...
df[df$ST_Modify_Display_and_View=="Not Attempted", "ST_Modify_Display_and_View"] <- "3"
df[df$ST_Modify_Display_and_View=="Not Applicable", "ST_Modify_Display_and_View"] <- "3"
...
df[df$ST_Measurements_and_Labeling=="Not Attempted", "ST_Measurements_and_Labeling"] <- "3"
df[df$ST_Measurements_and_Labeling=="Not Applicable", "ST_Measurements_and_Labeling"] <- "3"
...
df[df$ST_Script_Console_and_Script_Commands=="Not Attempted", "ST_Script_Console_and_Script_Commands"] <- "3"
df[df$ST_Script_Console_and_Script_Commands=="Not Applicable", "ST_Script_Console_and_Script_Commands"] <- "3"
...
df[df$ST_Surfaces_and_Orbitals=="Not Attempted", "ST_Surfaces_and_Orbitals"] <- "3"
df[df$ST_Surfaces_and_Orbitals=="Not Applicable", "ST_Surfaces_and_Orbitals"] <- "3"
...
df[df$ST_Crystal_Structure_and_Unit_Cell=="Not Attempted", "ST_Crystal_Structure_and_Unit_Cell"] <- "3"
df[df$ST_Crystal_Structure_and_Unit_Cell=="Not Applicable", "ST_Crystal_Structure_and_Unit_Cell"] <- "3"



#-------------------------------------------------------------------------------------------------------------#
#5) Part 5: Converting data type for EFA
#-------------------------------------------------------------------------------------------------------------#

# Casting all the numeric data as numeric data type
df <- data.frame(apply(df, 2, function(x) as.numeric(as.character(x))))
View(df)

#-------------------------------------------------------------------------------------------------------------#
#6) Part 6: Grouping columns 
#-------------------------------------------------------------------------------------------------------------#

# Grouping the data into 4 convenient chunks for processing: all columns, spoken tutorial and assigments related, concepts related and overall workshop feedback.
df_all <- df
...
# Saving the groups in separate csvs for future EFA analysis.
write.csv(df_all,"data_all.csv")
write.csv(df_spoken,"data_spoken.csv")
write.csv(df_concepts,"data_concepts.csv")
write.csv(df_overall,"data_overall.csv")
